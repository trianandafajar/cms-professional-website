    ...
    <div className="space-y-6 sm:space-y-8">
      <div>
        ...
        <p className="mt-1 max-w-2xl text-sm text-zinc-500">
          Manage your tax details for payout compliance
        </p>
      </div>

      {/* Info */}
      <div className="rounded-2xl border border-zinc-100 bg-zinc-50/50 p-4 sm:p-6">
        ...
        <div className="grid gap-3 sm:grid-cols-2">
          {[
            ...
            <a
              key={item}
              href="#"
              className="group flex cursor-pointer items-center rounded-xl border border-zinc-100 bg-white p-4 transition hover:border-[#5151eb]/20 hover:bg-[#5151eb]/5"
            >
      ...
      {/* Warning */}
      <div className="rounded-xl border border-amber-200/60 bg-amber-50/50 p-4 sm:p-5">
