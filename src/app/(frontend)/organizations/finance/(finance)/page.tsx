...
export default function FinancePage() {
  ...
  const { orders, isLoading: ordersLoading, error: ordersError, fetchOrders } = useOrdersStore()
  const {
    connections,
  ...
  useEffect(() => {
    ...
    void fetchOrders(user?.id ?? null)
    void fetchWorkspace()
  }, [hasHydrated, user?.id, fetchOrders, fetchWorkspace])
