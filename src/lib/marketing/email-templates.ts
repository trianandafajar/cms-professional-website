...
export const EMAIL_TEMPLATE_TOKEN_OPTIONS: TokenOption[] = [
  ...
  { key: 'orderUrl', label: 'Order URL', example: 'https://eventbro.com/my/orders/ORD-2026-0001' },
  { key: 'ticketsUrl', label: 'Tickets URL', example: 'https://eventbro.com/my/tickets' },
  { key: 'eventsUrl', label: 'Events URL', example: 'https://eventbro.com/events' },
